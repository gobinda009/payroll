...
import com.payroll.payroll.repository.EmployeeRepo;
...
public class AdminUsers {
    ...
    public ResponseEntity<Object> signUp(@RequestBody ReqRes employee){
        Employee employeeToSave = new Employee();
        employeeToSave.setName(employee.getName());
        return ResponseEntity.ok(employeeRepo.save(employeeToSave));
    }
